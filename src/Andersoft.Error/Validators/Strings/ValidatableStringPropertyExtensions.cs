...
public static class ValidatableStringPropertyExtensions
{
    ...
    where TValue : notnull
  {
    ...
    Result<Validatable<TValue>> Validate(Validatable<TValue> validatable)
    {
      ...
      {
        return new Result<Validatable<TValue>>(new ArgumentException(
          "String should not be null or whitespace.",
          $"{validatable.ParamName}: {funcName}"));
      }
  ...
  public static Result<Validatable<TValue>> IfShorterThan<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    int length,
    [CallerArgumentExpression("propertyFunc")] string? funcName = null)
  ...
  public static Result<Validatable<TValue>> IfLengthEquals<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    int length,
    [CallerArgumentExpression("propertyFunc")] string? funcName = null)
  ...
  public static Result<Validatable<TValue>> IfLengthNotEquals<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    int length,
    [CallerArgumentExpression("propertyFunc")] string? funcName = null)
    where TValue : notnull
  {
    ...
    Result<Validatable<TValue>> Validate(Validatable<TValue> validatable)
    {
      ...
      {
        return new Result<Validatable<TValue>>(new ArgumentException(
          $"String length should be equal to {length}.",
          $"{validatable.ParamName}: {funcName}"));
      }
  ...
  public static Result<Validatable<TValue>> IfWhiteSpace<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    [CallerArgumentExpression("propertyFunc")]
    ...
    where TValue : notnull
  {
    ...
    Result<Validatable<TValue>> Validate(Validatable<TValue> validatable)
    {
      ...
      {
        return new Result<Validatable<TValue>>(new ArgumentException(
          "String should not be white space only.",
          $"{validatable.ParamName}: {funcName}"));
      }
  ...
  public static Result<Validatable<TValue>> IfEmpty<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    [CallerArgumentExpression("propertyFunc")]
    string? funcName = null)
  ...
  public static Result<Validatable<TValue>> IfEqualsIgnoreCase<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    string otherString,
    [CallerArgumentExpression("propertyFunc")] string? funcName = null)
  ...
  public static Result<Validatable<TValue>> IfNotEqualsIgnoreCase<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    string otherString,
    [CallerArgumentExpression("propertyFunc")]
  ...
  public static Result<Validatable<TValue>> IfEquals<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    string otherString,
    StringComparison comparisonType = StringComparison.Ordinal,
  ...
  public static Result<Validatable<TValue>> IfNotEquals<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    string otherString,
    StringComparison comparisonType = StringComparison.Ordinal,
  ...
  public static Result<Validatable<TValue>> IfStartsWith<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    string otherString,
    StringComparison comparisonType = StringComparison.Ordinal,
  ...
  public static Result<Validatable<TValue>> IfNotStartsWith<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    string otherString,
    StringComparison comparisonType = StringComparison.Ordinal,
  ...
  public static Result<Validatable<TValue>> IfContains<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    string otherString,
    StringComparison comparisonType = StringComparison.Ordinal,
  ...
  public static Result<Validatable<TValue>> IfNotContains<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    string otherString,
    StringComparison comparisonType = StringComparison.Ordinal,
  ...
  public static Result<Validatable<TValue>> IfMatches<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    Regex regex,
    [CallerArgumentExpression("propertyFunc")]
  ...
  public static Result<Validatable<TValue>> IfNotMatches<TValue>(
    this Result<Validatable<TValue>> result,
    Func<TValue, string> propertyFunc,
    Regex regex,
    [CallerArgumentExpression("propertyFunc")]
